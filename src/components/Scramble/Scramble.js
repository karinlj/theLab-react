...
class Scramble extends Component {
  ...
  renderBtns = isLeftPosition => {
    //isLeftPosition: true eller false i två rader på en lapp. om isReversed i kolumner som tabell. fyller i i tabellen var ska knappen vara. Hälften ska vara till höger och tvärtom.
    //false + false = false
    //false + true = true
    //true + false = true
    //true + true = false
    ...
    if (
      (isLeftPosition && !this.state.isReversed) ||
      (!isLeftPosition && this.state.isReversed)
    ) {
      //to move the buttons
      return (
        <MainBtn
          ...
          classProp={this.state.class}
          clickProp={() => this.compare(true)}
        >
          {this.state.content}
        </MainBtn>
      );
            ...
            <div className="row justify-content-between">
              <div className="col">
                <div className="scrambleText">
                  <p>
                    Current button <strong>id</strong> is:{" "}
                    <strong>{this.state.id}</strong>
                  </p>

                  <p>
                    Current button <strong>class</strong> is:{" "}
                    <strong>{this.state.class}</strong>
                  </p>
                </div>
              </div>
              <div className="col">
            ...
            <div className="scrambleBtns">
              <div className="row justify-content-between">
                <div className="col-sm-6 col-md-12 col-xl-6">
                  <MainBtn
                    classProp={scrambleBtnClass}
                    clickProp={this.scrambleId}
                  >
                    Scramble Id
                  </MainBtn>
                </div>
                <div className="col-sm-6 col-md-12 col-xl-6">
                  <MainBtn
                    classProp={scrambleBtnClass}
                    clickProp={this.scrambleContent}
                  >
                    Scramble Content
                  </MainBtn>
                </div>
