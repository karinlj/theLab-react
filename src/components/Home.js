        ...
        <div className="home-section">
          ...
          <div className="card">
            <div className="card-body">
              ...
              <p>
                Test different aspects of web applications and practice how to
                do test automation.
              </p>
              <p>
                The site also to acts as a testing ground for your automation
                tools.
              </p>
              <p>
                Here you find a number of test categories, that each has a
                number of problems to solve. Each problem has a help text on how
                this is solved using the Boozang tool, and a video on how to
                solve it.{" "}
              </p>
              <p>
