        ...
        <div className="textComp-section">
          ...
          <div className="card">
            <div className="card-body">
              <p>
                Sometimes writing test automation code is as time-consuming as writing the code itself. 
                One could wonder if it's really worth it. Isn't writing the features more important than testing them?
                </p>
                <p>
                Perhaps this is accurate at the beginning of your applications life-cycle. But as your application grows, 
